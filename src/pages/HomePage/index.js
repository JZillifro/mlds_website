  ...
  render() {
    return (
      <div>
        ...
        <p>
          Membership is free and open to all UT students – both undergraduate and graduate. If you are new to machine learning and data science, we’d love to have you join us! Come to meetings on Tuesday nights @ 6:30 in EER 3.646 and check out our resources page for tips on how to get started.
        </p>

        <p>
          Access our Facebook group or the events page to learn more about meeting times/locations, topics covered, and competitions.
        </p>
      </div>
    );
  }
